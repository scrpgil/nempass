...
describe('NemProvider', () => {
    ...
    describe('fee test with prepareTransaction', () => {
        ...
        it('10xem fee"', () => {
            ...
            expect(nem.getCalcAmount(t.fee)).toBe(0.05);
        })
